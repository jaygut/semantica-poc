"""Nereus v4 Natural Capital Intelligence - Global Scaling Dashboard.
...
# ---------------------------------------------------------------------------
st.set_page_config(
    page_title="Nereus Natural Capital Intelligence",
    page_icon=None,
    layout="wide",
...
# ---------------------------------------------------------------------------
with st.sidebar:
    # Display the Nereus logo
    logo_path = Path(__file__).parent / "assets" / "nereus_logo.png"
    if logo_path.exists():
    ...
    st.markdown(
        ...
        <div style="text-align: center; margin-top: -15px; margin-bottom: 25px;">
            <div style="font-size: 26px; font-weight: 700; letter-spacing: 5px; color: #F1F5F9; text-transform: uppercase; font-family: 'Inter', sans-serif;">
                NEREUS
            </div>
            <div style="font-size: 11px; font-weight: 600; letter-spacing: 2px; color: #5B9BD5; text-transform: uppercase; margin-top: 4px; opacity: 0.8;">
                MARIS x SEMANTICA
            </div>
        </div>
        """,
    ...
    if st.session_state.v4_mode == "live":
        ...
        st.markdown(
            '<div class="conn-status conn-static" style="width:100%">'
    ...
    st.markdown(
        "<span style='font-size:13px;color:#64748B'>Bridge Axioms: 40</span>",
        unsafe_allow_html=True,
    )
